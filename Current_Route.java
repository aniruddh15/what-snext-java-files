...
public class Current_Route extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ll=getArguments().getString("lat")+","+getArguments().getString("lng");
...
//        i=pcount;
        ...
        RelativeLayout ray= (RelativeLayout) da.findViewById(R.id.mpd_relative);
        ...
        ray.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String dll=mlat[markc]+","+mlng[markc];
                String url="http://maps.google.com/maps?saddr="+ll+"&daddr="+dll;
